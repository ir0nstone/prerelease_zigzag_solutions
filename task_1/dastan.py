...
class Dastan:
    ...
    # edited here
    def __CreateCustomPlayers(self):
        p1_name = input("Enter name of player 1: ")

        p2_name = input("Enter name of player 2: ")
        while p1_name == p2_name:
            p2_name = input("Name is in use, please enter a new name for player 2: ")

        self._Players.append(Player(p1_name, 1))
        self._Players.append(Player(p2_name, -1))
