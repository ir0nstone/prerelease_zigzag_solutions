...
class Dastan:
    ...
    # moves are simple - either 1 in the x-axis and 2 in y-axis or vice-versa
    ...
    def __CreateMoveOption(self, Name, Direction):
        ...
        else:       # modified to add Faris
            return self.__CreateFarisMoveOption(Direction)

    # edited here to add Faris to queue after Ryott
    def __CreateMoveOptions(self):
        self._Players[0].AddToMoveOptionQueue(self.__CreateMoveOption("ryott", 1))
        self._Players[0].AddToMoveOptionQueue(self.__CreateMoveOption("faris", 1))              # wanted it after the ryott for both players
        ...
        self._Players[1].AddToMoveOptionQueue(self.__CreateMoveOption("faris", -1))             # wanted it after the ryott for both players
